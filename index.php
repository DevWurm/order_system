...
*/
	...
	if (check_session('user')) { //check if logged in
...
<html lang="en">
	...
	<body>
		<div>
			...
			<div id="login">
				<h2>Login</h2>
				<form method="post" action="login_user.php" onsubmit="return validate_login()">
			...
			<div>
				<form id="register" method="post" action="register_user.php" onsubmit="return validate_register()">
					<h2>Registrieren</h2>
