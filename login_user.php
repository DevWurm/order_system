...
include('./includes/login.php');
	...
	function login_user() {
		...
		if ($user_data != FALSE) { //check if input data is correctly transfered
			if (validate_login_data($user_data)) { //check if input data is valid
				if (validate_login($user_data, 'user')) { //check if login credentials are correct
